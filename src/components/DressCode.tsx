...
export default function DressCode() {
  ...
  return (
    <section className="px-6 py-20">
      ...
      >
        <p className="text-xs tracking-[0.4em] uppercase opacity-80 mb-3">
        ...
        <div className="mt-6 flex gap-2">
          ...
          <span className="w-8 h-8 rounded-full ring-2 ring-secondary-foreground/30" style={{ background: "hsl(var(--secondary))", filter: "brightness(1.3)" }} />
