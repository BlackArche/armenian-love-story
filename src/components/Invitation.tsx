...
export default function Invitation({ data }: { data: InvitationData }) {
  ...
  return (
    <section className="relative px-6 py-24 overflow-hidden">
      ...
      >
        <p className="text-xs tracking-[0.4em] uppercase text-primary mb-6">{texts.welcome}</p>
        ...
        <p className="mt-8 text-foreground/80 leading-relaxed">{texts.invitationLine1}</p>
        <p className="mt-2 text-foreground/80 leading-relaxed">{texts.invitationLine2}</p>
